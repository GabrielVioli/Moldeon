...
import {
  createPatternDocumentV3,
  projectPatternDocumentV3ToLegacy,
...
describe("paired physical-copy SeamGroups", () => {
  it("round-trips trouser front/back rise closures through PatternDocumentV3", () => {
    ...
    const document = createPatternDocumentV3(garment);
    ...
    const projected = projectPatternDocumentV3ToLegacy(document);
