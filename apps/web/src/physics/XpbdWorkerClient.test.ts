...
function initialization(revision: string, particleCount: number): XpbdInitializationData {
  ...
  return {
    ...
    triangleMaterialOrientations: new Int8Array(),
    ...
    bendIndices: new Uint32Array(),
    bendRestAngles: new Float32Array(),
    bendCompliances: new Float32Array(),
...
function frame(revision: string, generation: number, epoch: number, particleCount: number): XpbdFrame & { type: "positions" } {
  return {
    ...
    diagnostics: {
      ...
      structuralStretchMeanRatio: 1,
      structuralStretchMaxRatio: 1,
      structuralCompressionMinRatio: 1,
      shearStrainMean: 0,
      shearStrainMax: 0,
      triangleAreaMeanRatio: 1,
      triangleAreaMinRatio: 1,
      triangleAreaMaxRatio: 1,
      flippedTriangleCount: 0,
      garmentAabbGrowthRatio: 1,
      materialMetricsByPanel: {},
      materialMetricsByFabric: {},
      explicitPinCount: 0,
